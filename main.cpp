...
int main() {
    ...
    // 反汇编器
    vector<string> res = disassembler("00010001001010100000000000000010001000010100100111111100000110010000100000010000000000000000001110101101010010010000000000001000");
    for (auto &i : res) {
        cout << i << endl;
    }
    return 0;
